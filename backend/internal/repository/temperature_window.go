...
type TemperatureWindowRepository interface {
	...
	FindByCode(context.Context, string) (model.TemperatureWindow, error)
...
func (r *temperatureWindowRepository) FindByCode(ctx context.Context, code string) (model.TemperatureWindow, error) {
