...
type TransportContainerRepository interface {
	...
	FindByCode(context.Context, string) (model.TransportContainer, error)
...
func (r *transportContainerRepository) FindByCode(ctx context.Context, code string) (model.TransportContainer, error) {
